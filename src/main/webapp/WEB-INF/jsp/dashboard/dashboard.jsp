...
<div class="mainContent">
	<div class="item-container item-wrapper">
		...
		<div>
			<div class="item-table-wrapper last-margin-bottom" >
				<div class="item-table-title"  style="margin-top: 20px;">
					<img src="${contextPath}/assets/images/Colo_Banner.png"  style="width:100%;">
				</div>
				<div class="item-table-title" style="margin-top: 20px;">
					<div class="item-flexbox-bs">
						<h2>공지사항</h2>
					</div>
				</div>
				<div class="item-jqgrid">
					<table id="noticeList">
					</table>
				</div>

...
!function (n) {
        "function" == typeof define && define.amd
            ...
            r.prototype.bind = function (t, e) {
                ...
                h.fn.mousewheel && this.$results.on("mousewheel", function (e) {
                    ...
                    r
                        ...
                        : i && (l.$results.scrollTop(l
                            .$results
                            .get(0)
                            .scrollHeight - l.$results.height()), e.preventDefault(), e.stopPropagation())
                }),
        ...
        }), e.define("select2/selection/base", [
            "jquery", "../utils", "../keys"
        ], function (n, r, i) {
            function o(e, t) {
                this.$element = e,
            ...
            o
        }), e.define("select2/selection/single", [
            ...
            i
        }), e.define("select2/selection/multiple", [
            "jquery", "./base", "../utils"
        ], function (i, e, l) {
            function n(e, t) {
                n
            ...
            t
        }), e.define("select2/selection/allowClear", [
            "jquery", "../keys", "../utils"
        ], function (i, r, a) {
            function e() {}
            ...
            e
        }), e.define("select2/selection/search", [
            "jquery", "../utils", "../keys"
        ], function (r, a, l) {
            function e(e, t, n) {
                e.call(this, t, n)
            ...
            n
        }), e.define("select2/dropdown/search", [
            "jquery", "../utils"
        ], function (o, e) {
            function t() {}
            ...
            e.prototype.loadMoreIfNeeded = function () {
                ...
                if (!this.loading && e) {
                    var t = this
                        .$results
                        .offset()
                        .top + this.$results.outerHeight(!1);
                    this
                        .$loadingMore
                        .offset()
                        .top + this.$loadingMore.outerHeight(!1) <= t + 50 && this.loadMore()
                }
            },
            ...
            e
        }), e.define("select2/dropdown/attachBody", [
            "jquery", "../utils"
        ], function (f, a) {
            function e(e, t, n) {
            ...
            e.prototype._positionDropdown = function () {
                ...
                null != r && (this
                    ...
                    .addClass("select2-dropdown--" + r), this
                    .$container
            ...
            n.prototype.applyFromElement = function (e, t) {
                var n = e.language,
                    ...
                    s = Array
                        .prototype
                        .concat
                        .call(this._resolveLanguage(i), this._resolveLanguage(n), this._resolveLanguage(r), this._resolveLanguage(o));
                return e.language = s,
                e
            },
            ...
            return e.prototype.fromElement = function (e) {
                ...
                d.fn.jquery && "1." == d
                    .fn
                    .jquery
                    .substr(0, 2) && e[0].dataset && (n = d.extend(!0, {}, e[0].dataset, n));
